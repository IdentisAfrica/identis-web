    ...
    <div className="min-h-screen bg-[#0a0f1c] text-white">
      ...
      <main className="container mx-auto px-4 py-20">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          <div className="bg-white/[0.03] border border-white/10 rounded-xl p-6 hover:border-[#00ff88] hover:shadow-lg hover:shadow-[#00ff88]/20 transition-all hover:-translate-y-1">
        ...
        <div className="max-w-3xl mx-auto bg-white/[0.03] border border-white/10 rounded-xl p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <input type="text" id="name" required className="w-full px-4 py-3 bg-white/[0.03] border border-white/20 rounded-lg text-white focus:outline-none focus:border-[#00ff88] focus:ring-2 focus:ring-[#00ff88]/20 transition" />
            </div>

            <div>
              <label htmlFor="email" className="block text-white/90 font-medium mb-2">Email *</label>
              <input type="email" id="email" required className="w-full px-4 py-3 bg-white/[0.03] border border-white/20 rounded-lg text-white focus:outline-none focus:border-[#00ff88] focus:ring-2 focus:ring-[#00ff88]/20 transition" />
            </div>

            <div>
              <label htmlFor="subject" className="block text-white/90 font-medium mb-2">Subject *</label>
              <input type="text" id="subject" required className="w-full px-4 py-3 bg-white/[0.03] border border-white/20 rounded-lg text-white focus:outline-none focus:border-[#00ff88] focus:ring-2 focus:ring-[#00ff88]/20 transition" />
            </div>

            <div>
              <label htmlFor="message" className="block text-white/90 font-medium mb-2">Message *</label>
              <textarea id="message" required rows={6} className="w-full px-4 py-3 bg-white/[0.03] border border-white/20 rounded-lg text-white focus:outline-none focus:border-[#00ff88] focus:ring-2 focus:ring-[#00ff88]/20 transition resize-y" />
            </div>

            <button type="submit" className="w-full py-3 bg-gradient-to-r from-[#00ff88] to-[#00d4ff] text-[#0a0f1c] font-bold rounded-lg hover:shadow-lg hover:shadow-[#00ff88]/30 hover:-translate-y-0.5 transition-all">
              Send Message
            </button>
          </form>
        </div>
